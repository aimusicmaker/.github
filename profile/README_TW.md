...
| 你想做什麼 | 開啟工具 | 先準備什麼 |
| :-- | :-- | :-- |
| 寫一首歌 | [歌曲生成器](https://musicmaker.im/ai-song-generator/) ↗ | 想要的情緒、樂器，以及你已寫好的原創歌詞（如有）。 |
| 尋找歌詞靈感 | [歌詞生成器](https://musicmaker.im/ai-lyrics-generator/) ↗ | 主題、敘述視角和副歌想表達的內容。 |
| 製作畫面 | [音樂影片生成器](https://musicmaker.im/ai-music-video-generator/) ↗ | 你有權使用的音樂和簡短場景描述。 |
| 設計發行封面 | [專輯封面工具](https://musicmaker.im/ai-image-generator/album-cover-maker/) ↗ | 視覺風格，以及你有權使用的參考圖（如需）。 |
| 整理音符 | [音訊轉音符（MIDI）](https://musicmaker.im/audio-to-midi/) ↗ | 準備音訊，將它轉為可編輯的音符資料；轉換後檢查轉錄結果。 |
| 試做短片 | [短音樂影片工具](https://musicmaker.im/free-short-music-video-generator/) ↗ | 一個簡單鏡頭；生成前查看工具目前限制。 |
