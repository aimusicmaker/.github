...
<a href="https://musicmaker.im/ko/"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/ko-website.svg" alt="공식 웹사이트 방문"></a> <a href="#guides"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/ko-github.svg" alt="오픈 소스 가이드"></a>
...
| 다음 단계 | 도구 열기 | 준비할 것 |
| :-- | :-- | :-- |
| 노래 쓰기 | [노래 생성기](https://musicmaker.im/ai-song-generator/) ↗ | 분위기, 악기, 직접 쓴 가사가 있다면 함께 준비하세요. |
| 가사 구상하기 | [가사 생성기](https://musicmaker.im/ai-lyrics-generator/) ↗ | 주제, 화자의 관점, 후렴 아이디어. |
| 영상 만들기 | [뮤직비디오 생성기](https://musicmaker.im/ai-music-video-generator/) ↗ | 사용 권한이 있는 음악과 짧은 장면 설명. |
| 발매용 커버 디자인하기 | [앨범 커버 제작기](https://musicmaker.im/ai-image-generator/album-cover-maker/) ↗ | 시각적 방향과 사용 허가를 받은 참고 이미지. |
| 음표 편집하기 | [오디오를 MIDI로 변환](https://musicmaker.im/audio-to-midi/) ↗ | 편집 가능한 음표 데이터로 바꿀 오디오 파일. 변환 결과를 확인하세요. |
| 짧은 영상 시도하기 | [짧은 음악 영상 도구](https://musicmaker.im/free-short-music-video-generator/) ↗ | 간단한 장면 하나. 생성하기 전에 도구의 현재 제한을 확인하세요. |
