...
<a href="https://github.com/aimusicmaker/.github/blob/main/profile/README_TW.md"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/tw-desktop.svg" height="40" alt="桌面版首頁"></a>
...
> 這是為本頁編寫的入門描述，尚未進行生成實測。效果會隨工具、模型和設定變化。
...
適合寫歌的人：查看 Suno 官方資料、試聽參考、提示詞、原創歌詞及常見問題處理方法。這是獨立整理的指南，不是 Suno 官方文件。

<a href="https://github.com/aimusicmaker/awesome-suno-creator-guide/blob/main/README_TW.md"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/songwriting-guide.png" width="900" alt="歌曲創作指南的橙色唱片封面。原創編輯插畫，畫面文字為英文，不是產品截圖。"></a>

歌曲創作指南的橙色唱片封面。原創編輯插畫，畫面文字為英文，不是產品截圖。

[查看原圖 ↗](https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/songwriting-guide.png)
...
適合影片創作者：從歌曲出發規劃鏡頭，使用附有來源的案例、可複製提示詞和剪輯練習。指南區分了創作者案例與新編練習。

<a href="https://github.com/aimusicmaker/awesome-music-video-creator-guide/blob/main/README_TW.md"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/music-video-workflow.png" width="900" alt="流程示意：選擇音樂 → 規劃鏡頭 → 生成畫面 → 剪輯匯出。英文概念插畫，不是產品截圖，也不是影片實測成果。"></a>

流程示意：選擇音樂 → 規劃鏡頭 → 生成畫面 → 剪輯匯出。英文概念插畫，不是產品截圖，也不是影片實測成果。

[查看原圖 ↗](https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/music-video-workflow.png)
...
想要的情緒、樂器，以及你已寫好的原創歌詞（如有）。

### 尋找歌詞靈感

[歌詞生成器](https://musicmaker.im/ai-lyrics-generator/) ↗

主題、敘述視角和副歌想表達的內容。

### 製作畫面

[音樂影片生成器](https://musicmaker.im/ai-music-video-generator/) ↗

你有權使用的音樂和簡短場景描述。

### 設計發行封面

[專輯封面工具](https://musicmaker.im/ai-image-generator/album-cover-maker/) ↗

視覺風格，以及你有權使用的參考圖（如需）。

### 整理音符

[音訊轉音符（MIDI）](https://musicmaker.im/audio-to-midi/) ↗

準備音訊，將它轉為可編輯的音符資料；轉換後檢查轉錄結果。

### 試做短片

[短音樂影片工具](https://musicmaker.im/free-short-music-video-generator/) ↗

一個簡單鏡頭；生成前查看工具目前限制。


可選模型、點數、下載和商用權限取決於目前產品及方案。發布作品或用於客戶專案之前，請查看價格與商用授權。

[方案與價格](https://musicmaker.im/pricing/) · [商用授權](https://musicmaker.im/commercial-license/) · [服務條款](https://musicmaker.im/terms-of-service/)
...
產品入口、官網語言和聯盟條款核對日期：2026-09-23。來源及維護說明見下方連結。

[來源與維護說明](https://github.com/aimusicmaker/.github/blob/main/docs/SOURCES.md)
...
[閱讀聯盟協議](https://musicmaker.im/affiliate-agreement/)
