...
<table><tr>
<td width="50%" valign="top"><h3>♫ Awesome Suno Creator Guide</h3><p>Изучите официальные демо Suno и работы авторов: от фолка и танцевальной музыки до джаза, фортепианных композиций и музыки для кино. Выберите направление, попробуйте запросы и следуйте урокам, чтобы развить свою песню или аранжировку.</p><a href="https://github.com/aimusicmaker/awesome-suno-creator-guide/blob/main/README_RU.md"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/songwriting-guide.png" width="440" alt="Идеи для песен: фортепиано, джаз, акустическая гитара, танцевальная музыка и анимация. Обложка руководства с надписями на английском языке."></a><p>Идеи для песен: фортепиано, джаз, акустическая гитара, танцевальная музыка и анимация. Обложка руководства с надписями на английском языке.</p><p><a href="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/songwriting-guide.png">Открыть изображение в полном размере ↗</a></p><a href="https://github.com/aimusicmaker/awesome-suno-creator-guide/blob/main/README_RU.md"><b>Открыть руководство по созданию песен →</b></a></td>
<td width="50%" valign="top"><h3>▶ Awesome Music Video Creator Guide</h3><p>Превратите песню в анонс релиза, видео с исполнением или зацикленный видеоряд. Изучите официальные демонстрации моделей и работы авторов, затем пройдите уроки по созданию сцен природы и поющих портретов — от планирования до монтажа.</p><a href="https://github.com/aimusicmaker/awesome-music-video-creator-guide/blob/main/README_RU.md"><img src="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/music-video-workflow.png" width="440" alt="От музыки к видео: выбрать музыку, спланировать кадры, сгенерировать фрагменты, смонтировать и экспортировать. Иллюстрированная схема с подписями на английском языке."></a><p>От музыки к видео: выбрать музыку, спланировать кадры, сгенерировать фрагменты, смонтировать и экспортировать. Иллюстрированная схема с подписями на английском языке.</p><p><a href="https://raw.githubusercontent.com/aimusicmaker/.github/main/assets/music-video-workflow.png">Открыть изображение в полном размере ↗</a></p><a href="https://github.com/aimusicmaker/awesome-music-video-creator-guide/blob/main/README_RU.md"><b>Спланировать первое музыкальное видео →</b></a></td>
</tr></table>
...
| Следующий шаг | Открыть инструмент | Что подготовить |
| :-- | :-- | :-- |
| Написать песню | [Генератор песен](https://musicmaker.im/ai-song-generator/) ↗ | Настроение, инструменты и собственный текст, если он есть. |
| Найти слова | [Генератор текстов песен](https://musicmaker.im/ai-lyrics-generator/) ↗ | Тему, точку зрения и идею припева. |
| Создать видеоряд | [Генератор музыкальных видео](https://musicmaker.im/ai-music-video-generator/) ↗ | Музыку, которую вам разрешено использовать, и краткое описание сцены. |
| Оформить обложку релиза | [Генератор обложек альбомов](https://musicmaker.im/ai-image-generator/album-cover-maker/) ↗ | Визуальное направление и при необходимости изображения-образцы, разрешённые к использованию. |
| Работать с нотами | [Аудио в MIDI (редактируемые ноты)](https://musicmaker.im/audio-to-midi/) ↗ | Аудиофайл для преобразования в редактируемые нотные данные; проверьте результат распознавания. |
| Попробовать короткий ролик | [Инструмент для коротких музыкальных видео](https://musicmaker.im/free-short-music-video-generator/) ↗ | Один простой кадр; перед генерацией проверьте действующие ограничения инструмента. |
