...
def header_badge(code, key, label, text, url, color):
 ...
 write(asset, svg)
 return f'<a href="{url}"><img src="{RAW}/{asset}" height="28" alt="{html.escape(text, quote=True)}"></a>'
for code,name in LANGS:
 for mobile in (False, True):
  ...
  github_button = header_badge(code, 'github', 'GITHUB', t['nav'][1].upper(), 'https://github.com/aimusicmaker', '#181717')
